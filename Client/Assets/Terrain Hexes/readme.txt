...
- due to popular demand, adapted to hex tiles from my set of painted square terrain tiles
- 6 biomes x 4 variations = 24 tiles total 
...
Do note that this does not actually require Unity 5.1.3 or higher - this is a tilesheet saved as a png and split and named into sprites. There are also the individual tiles in a separate folder if that's how you roll.
